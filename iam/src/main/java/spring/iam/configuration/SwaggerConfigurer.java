...
public class SwaggerConfigurer {
  ...
  public GroupedOpenApi publicApi() {
    return GroupedOpenApi.builder().group("public").packagesToScan("spring.iam.controller").build();
  }
  ...
  public OpenAPI myOpenAPI() {
    ...
    Info info =
        new Info()
            .title("Spring Rest Monolithic Service")
            .version("1.0")
            .contact(contact)
            .description("Spring Rest Monolithic Service")
