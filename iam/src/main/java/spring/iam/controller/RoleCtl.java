...
public class RoleCtl {
  ...
  public ResponseEntity<ResponsePaging<List<RoleRes>>> findAll(
    ...
    var response =
        ResponsePaging.<List<RoleRes>>builder()
            .code(ok.getCode())
            .message(ok.getMessage())
  ...
  public ResponseEntity<Response<Long>> updateById(
      @PathVariable(name = "id", required = true) Long id, @RequestBody RoleUpd update) {
