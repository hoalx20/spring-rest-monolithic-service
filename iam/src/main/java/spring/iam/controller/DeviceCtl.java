...
public class DeviceCtl {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<Response<DeviceRes>> findById(
      @PathVariable(name = "id", required = true) Long id) {
    Success ok = Success.FIND_BY_ID;
    DeviceRes queried = deviceSrv.findById(id);
    Response<DeviceRes> response =
        Response.<DeviceRes>builder()
            .code(ok.getCode())
  ...
  public ResponseEntity<ResponsePaging<List<DeviceRes>>> findAll(
    ...
    var response =
        ResponsePaging.<List<DeviceRes>>builder()
            .code(ok.getCode())
            .message(ok.getMessage())
  ...
  public ResponseEntity<Response<Long>> updateById(
      @PathVariable(name = "id", required = true) Long id, @RequestBody DeviceUpd update) {
