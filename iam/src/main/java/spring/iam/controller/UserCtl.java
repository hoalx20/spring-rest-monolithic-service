...
public class UserCtl {
  @Qualifier("userRepo") IUserSrv userRepo;
  ...
  public ResponseEntity<ResponsePaging<List<UserRes>>> findAll(
    ...
    var response =
        ResponsePaging.<List<UserRes>>builder()
            .code(ok.getCode())
            .message(ok.getMessage())
  ...
  public ResponseEntity<Response<Long>> updateById(
      @PathVariable(name = "id", required = true) Long id, @RequestBody UserUpd update) {
