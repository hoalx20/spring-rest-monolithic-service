...
public class AuthCtl {
  ...
  @ApiResponse(
      ...
      content = {
        @Content(
            schema = @Schema(implementation = CredentialRes.class),
            mediaType = "application/json")
      })
  @ApiResponse(
      responseCode = "400",
      description =
          "Bad request: missing username, password, roleIds, username already exists, etc...",
      content = {@Content(schema = @Schema(), mediaType = "application/json")})
  @ApiResponse(
      responseCode = "500",
      description = "Internal server error: uncategorized error",
      content = {@Content(schema = @Schema(), mediaType = "application/json")})
  @PostMapping("/sign-up")
  public ResponseEntity<Response<CredentialRes>> signUp(@RequestBody @Valid RegisterReq request) {
    ...
    var response =
        Response.<CredentialRes>builder()
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Bad request: missing username, password, username not exists, etc...",
      content = {@Content(schema = @Schema(), mediaType = "application/json")})
  @ApiResponse(
      responseCode = "500",
      description = "Internal server error: uncategorized error",
  ...
  @Operation(
      ...
      description = "Retrieve profile endpoint for existing user")
  @ApiResponse(
      responseCode = "200",
      description = "Ok: Success",
      content = {
  ...
  @ApiResponse(
      responseCode = "401",
      description = "Unauthorized: missing accessToken, token is ill legal, etc...",
      content = {@Content(schema = @Schema(), mediaType = "application/json")})
  @ApiResponse(
      responseCode = "500",
      description = "Internal server error: uncategorized error",
  ...
  public ResponseEntity<Response<Long>> signOut(Authentication authentication) {
    ...
    var user =
        ((AuthenticationDetail)
            ((HashMap<String, Object>) authentication.getDetails()).get("user"));
    var badCredential =
        new BadCredentialCre(user.getSessionId(), user.getSessionExpiredAt(), user.getUserId());
  ...
  @ApiResponse(
      ...
      content = {
        @Content(
            schema = @Schema(implementation = RegisterRes.class),
            mediaType = "application/json")
      })
  @ApiResponse(
      responseCode = "401",
      description =
          "Unauthorized: missing accessToken, fresh token, token is ill legal, edited, etc...",
      content = {@Content(schema = @Schema(), mediaType = "application/json")})
  @ApiResponse(
      responseCode = "500",
      description = "Internal server error: uncategorized error",
  ...
  @SecurityRequirement(name = "Authorization")
  @PostMapping("/refresh")
  public ResponseEntity<Response<CredentialRes>> refresh(
    ...
    Response<CredentialRes> response =
        Response.<CredentialRes>builder()
            .code(ok.getCode())
            .message(ok.getMessage())
            .payload(credential)
