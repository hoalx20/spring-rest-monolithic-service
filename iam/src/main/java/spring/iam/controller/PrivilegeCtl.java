...
public class PrivilegeCtl {
  ...
  public ResponseEntity<ResponsePaging<List<PrivilegeRes>>> findAll(
    ...
    var response =
        ResponsePaging.<List<PrivilegeRes>>builder()
            .code(ok.getCode())
            .message(ok.getMessage())
  ...
  public ResponseEntity<Response<Long>> updateById(
      @PathVariable(name = "id", required = true) Long id, @RequestBody PrivilegeUpd update) {
